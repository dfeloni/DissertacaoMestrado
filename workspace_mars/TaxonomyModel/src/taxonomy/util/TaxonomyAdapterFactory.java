...
public class TaxonomyAdapterFactory extends AdapterFactoryImpl {
	...
	protected TaxonomySwitch<Adapter> modelSwitch =
		new TaxonomySwitch<Adapter>() {
			...
			@Override
			public Adapter caseTaxonomyElement(TaxonomyElement object) {
				return createTaxonomyElementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link taxonomy.Taxonomy <em>Taxonomy</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link taxonomy.TaxonomyElement <em>Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link taxonomy.ElementType <em>Element Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link taxonomy.Synonym <em>Synonym</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
