...
public class TaxonomySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TaxonomyPackage.TAXONOMY_ELEMENT: {
				TaxonomyElement taxonomyElement = (TaxonomyElement)theEObject;
				T result = caseTaxonomyElement(taxonomyElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TaxonomyPackage.ELEMENT_TYPE: {
				ElementType elementType = (ElementType)theEObject;
				T result = caseElementType(elementType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TaxonomyPackage.SYNONYM: {
	 ...
	 * @generated
	 */
	public T caseTaxonomyElement(TaxonomyElement object) {
		return null;
	}
