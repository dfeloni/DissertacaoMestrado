...
/**
 * This is the item provider adapter for a {@link structureAndBehavior.Tool} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StructureAndBehaviorPackage.Literals.TOOL__NAME,
				 true,
				 false,
				 false,
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tool_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tool_version_feature", "_UI_Tool_type"),
				 StructureAndBehaviorPackage.Literals.TOOL__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StructureAndBehaviorPackage.Literals.TOOL__URL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addToolTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tool_toolType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tool_toolType_feature", "_UI_Tool_type"),
				 StructureAndBehaviorPackage.Literals.TOOL__TOOL_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
