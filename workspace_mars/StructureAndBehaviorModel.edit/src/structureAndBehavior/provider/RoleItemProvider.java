...
/**
 * This is the item provider adapter for a {@link structureAndBehavior.Role} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleItemProvider extends ElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Role_requirements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Role_requirements_feature", "_UI_Role_type"),
				 StructureAndBehaviorPackage.Literals.ROLE__REQUIREMENTS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StructureAndBehaviorPackage.Literals.ROLE__ROLE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
