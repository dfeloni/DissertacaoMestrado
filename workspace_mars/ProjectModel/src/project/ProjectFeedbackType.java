 ...
 * <!-- end-user-doc -->
 * @see project.ProjectPackage#getProjectFeedbackType()
 * @model
 * @generated
 */
public enum ProjectFeedbackType implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final ProjectFeedbackType[] VALUES_ARRAY =
		new ProjectFeedbackType[] {
			NEGATIVE,
			POSITIVE,
		};
	 ...
	 * @generated
	 */
	public static final List<ProjectFeedbackType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static ProjectFeedbackType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ProjectFeedbackType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static ProjectFeedbackType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ProjectFeedbackType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static ProjectFeedbackType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ProjectFeedbackType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
