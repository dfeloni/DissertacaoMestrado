	...
	protected void addResultPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComplianceItem_result_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComplianceItem_result_feature", "_UI_ComplianceItem_type"),
				 AssessmentPackage.Literals.COMPLIANCE_ITEM__RESULT,
				 true,
				 false,
				 true,
				 null,
