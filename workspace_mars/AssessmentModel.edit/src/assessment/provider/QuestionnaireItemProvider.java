...
/**
 * This is the item provider adapter for a {@link assessment.Questionnaire} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QuestionnaireItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Questionnaire_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Questionnaire_name_feature", "_UI_Questionnaire_type"),
				 AssessmentPackage.Literals.QUESTIONNAIRE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Questionnaire_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Questionnaire_description_feature", "_UI_Questionnaire_type"),
				 AssessmentPackage.Literals.QUESTIONNAIRE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addProcessAreaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Questionnaire_processArea_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Questionnaire_processArea_feature", "_UI_Questionnaire_type"),
				 AssessmentPackage.Literals.QUESTIONNAIRE__PROCESS_AREA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMaturityLevelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Questionnaire_maturityLevel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Questionnaire_maturityLevel_feature", "_UI_Questionnaire_type"),
				 AssessmentPackage.Literals.QUESTIONNAIRE__MATURITY_LEVEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AssessmentPackage.Literals.QUESTIONNAIRE__EVALUATES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AssessmentPackage.Literals.QUESTIONNAIRE__EVALUATES,
				 AssessmentFactory.eINSTANCE.createComplianceItem()));
	}
