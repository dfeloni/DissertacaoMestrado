...
/**
 * This is the item provider adapter for a {@link assessment.Question} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QuestionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AssessmentPackage.Literals.QUESTION__QUESTION,
				 true,
				 false,
				 false,
	...
	protected void addWeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Question_weight_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Question_weight_feature", "_UI_Question_type"),
				 AssessmentPackage.Literals.QUESTION__WEIGHT,
				 true,
				 false,
				 false,
	...
	protected void addUserAnswerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Question_userAnswer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Question_userAnswer_feature", "_UI_Question_type"),
				 AssessmentPackage.Literals.QUESTION__USER_ANSWER,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AssessmentPackage.Literals.QUESTION__EVALUATES_BY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AssessmentPackage.Literals.QUESTION__EVALUATES_BY,
				 AssessmentFactory.eINSTANCE.createAnswerOption()));
	}
