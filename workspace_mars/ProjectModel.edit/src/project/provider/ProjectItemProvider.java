...
public class ProjectItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addEstimatedCostPropertyDescriptor(object);
			...
			addRealCostPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Estimated Cost feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addEstimatedCostPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_estimatedCost_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_estimatedCost_feature", "_UI_Project_type"),
				 ProjectPackage.Literals.PROJECT__ESTIMATED_COST,
				 true,
				 false,
				 false,
	...
	protected void addEstimatedEffortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_estimatedEffort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_estimatedEffort_feature", "_UI_Project_type"),
				 ProjectPackage.Literals.PROJECT__ESTIMATED_EFFORT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Real Cost feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addRealCostPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_realCost_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_realCost_feature", "_UI_Project_type"),
				 ProjectPackage.Literals.PROJECT__REAL_COST,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
