...
public class ReportAdapterFactory extends AdapterFactoryImpl {
	...
	protected ReportSwitch<Adapter> modelSwitch =
		new ReportSwitch<Adapter>() {
			...
			@Override
			public Adapter caseReportItem(ReportItem object) {
				return createReportItemAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link report.Report <em>Report</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link report.ReportItem <em>Item</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
