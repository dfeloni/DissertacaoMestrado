...
public class StructureAndBehaviorFactoryImpl extends EFactoryImpl implements StructureAndBehaviorFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case StructureAndBehaviorPackage.PHASE: return createPhase();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case StructureAndBehaviorPackage.EVIDENCE_TYPE:
				return createEvidenceTypeFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case StructureAndBehaviorPackage.EVIDENCE_TYPE:
				return convertEvidenceTypeToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public EvidenceType createEvidenceTypeFromString(EDataType eDataType, String initialValue) {
		EvidenceType result = EvidenceType.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertEvidenceTypeToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
