 ...
 * @generated
 */
public class StructureAndBehaviorSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public StructureAndBehaviorSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StructureAndBehaviorPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StructureAndBehaviorPackage.ACTIVITY: {
			...
			case StructureAndBehaviorPackage.WORK_PRODUCT: {
			...
			case StructureAndBehaviorPackage.TOOL: {
				Tool tool = (Tool)theEObject;
				T result = caseTool(tool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StructureAndBehaviorPackage.TASK: {
				Task task = (Task)theEObject;
				T result = caseTask(task);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StructureAndBehaviorPackage.ROLE: {
			...
			case StructureAndBehaviorPackage.PHASE: {
